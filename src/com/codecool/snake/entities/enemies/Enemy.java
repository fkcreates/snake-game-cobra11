...
public abstract class Enemy extends GameEntity {
    ...
    public double[] canSpawn() {
        ...
        double[] snakeHead1Pos = {Globals.getInstance().game.getSnakes().get(0).getHead().getPosition().x, Globals.getInstance().game.getSnakes().get(0).getHead().getPosition().y };
        double[] snakeHead2Pos = {Globals.getInstance().game.getSnakes().get(1).getHead().getPosition().x, Globals.getInstance().game.getSnakes().get(1).getHead().getPosition().y };
        double x;
        double y;
